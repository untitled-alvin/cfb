...
abstract class CFBBase<State>
  ...
  CFBBase(this._state) {
    ...
    _cfbObserver.onCreate(this);
  }

  final _cfbObserver = CFB.observer;
  ...
  /// Whether the cfb is closed.
  ///
  /// A cfb is considered closed once [close] is called.
  /// Subsequent state changes cannot occur within a closed cfb.
  @override
  ...
  ///
  /// * Throws a [StateError] if the cfb is closed.
  @protected
  @visibleForTesting
  @override
  void emit(State state) {
  ...
  void onChange(Change<State> change) {
    // ignore: invalid_use_of_protected_member
    _cfbObserver.onChange(this, change);
  }
  ...
  /// Called whenever an [error] occurs and notifies [CFBObserver.onError].
  ///
  ...
  void onError(Object error, StackTrace stackTrace) {
    // ignore: invalid_use_of_protected_member
    _cfbObserver.onError(this, error, stackTrace);
  }
